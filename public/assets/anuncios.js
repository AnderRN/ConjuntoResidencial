...
async function fetchAnuncios(limit){
    // CAMBIO 2: Usar la URL absoluta para GET /api/anuncios
    const res = await fetch(API_ENDPOINT + '/anuncios');
...
document.addEventListener('DOMContentLoaded', async ()=>{
    ...
    if(adminCards){
        ...
        adminCards.querySelectorAll('.del').forEach(b=> b.addEventListener('click', async (e)=>{
            ...
            // CAMBIO 3: Usar la URL absoluta para DELETE /api/admin/anuncios/
